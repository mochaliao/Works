...
(function (t, e, i) {
	...
	var attrdata = document.getElementById("attr-data");
	function m() {
		function i(t) {
			t.which > 1 || t.shiftKey || t.altKey || t.metaKey || t.ctrlKey || (t.preventDefault(), p(this))
		}
		var _Sx;var _Ex;var instantX;
		document.addEventListener("touchstart",function(e){
	     _Sx=e.touches[0].pageX;
			});

		document.addEventListener("touchend",function(e){
	     _Ex=e.changedTouches[0].pageX;

		instantX = Number(_Sx) - Number(_Ex)
		if(instantX>50 && (attrdata.getAttribute('data'))=='2'){
			J.next()
			}
		if(instantX<-50 && (attrdata.getAttribute('data'))=='2'){
			J.prev()
...
var iwidth = document.body.clientWidth;
	function w() {
		...
		q = !0, U = !1, A = E[j], d(), c(he), c(oe, O.onLoad), O.h = O.height ? l(O.height, "y") - N - _ : O.innerHeight && l(O.innerHeight, "y"), O.w = O.width ? l(O.width, "x") - z - D : O.innerWidth && l(O.innerWidth, "x"), O.mw = O.w, O.mh = O.h, O.maxWidth && (O.mw = l(O.maxWidth, "x") - z - D, O.mw = O.w && O.w < O.mw ? O.w : O.mw), O.maxHeight && (O.mh = l(O.maxHeight, "y") - N - _, O.mh = O.h && O.h < O.mh ? O.h : O.mh), n = O.href, Q = setTimeout(function () {
			...
			}, O.mw && U.width > O.mw && (e = (U.width - O.mw) / U.width, r()), O.mh && U.height > O.mh && (e = (U.height - O.mh) / U.height, r())), O.h && (U.style.marginTop = Math.max(O.mh - U.height, 0) / 2 + "px"), E[1] && (O.loop || E[j + 1]) && (U.style.cursor = "pointer",
			U.onclick = function () {
				if(iwidth>768){
					J.next();
				}
	...
	var g, y, v, x, b, T, C, k, E, H, W, F, L, S, M, R, I, K, P, B, O, _, D, N, z, A, j, U, $, q, G, Q, J, V, X, Y = {
			...
			title: !1,
			rel: !1,
			opacity: .7,  //20180201  modify
			preloading: true, //20180326 modify !0
			className: !1,
			retinaImage: !1,
			retinaUrl: !1,
			retinaSuffix: "@2x.$1",
