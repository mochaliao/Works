...
<div class="wrapper">
    ...
    <div class="noticebox main-content">
        <h4 class="notify-subtitle"><?php echo $this->lang->line('your-notification');?></h4>

        <?php foreach ($datas as $data): ?>
            <div class="notice-wrapper " style="cursor:pointer;"
                 onclick="location.href='<?php echo $data->target_path; ?>';">
                <div class="notice-head">
                    <a href="<?php echo $data->target_path; ?>">
                        <img src="<?php echo $data->member["avatar"]; ?>"
                             onerror="this.src='/assets/img/self-user-pic.jpg'">
                    </a>
                </div>
                <?php
                switch($data->text){
                case "Tag": $text = $this->lang->line('has-tag-you');; break;
                case "Comment": $text = $this->lang->line('has-comment');; break;
                case "Wall": $text = $this->lang->line('has-post-on');; break;
                case "Thumb": $text = $this->lang->line('has-thumb-on-post');; break;
                default: $text = $data->text; break;
                }
                ?>
                <div class="notice-txt">
                    <a href="/page/info?i=<?php echo $data->member["member_id"]; ?>"><?php echo $data->member["nickname"]; ?></a>
                    <!--、<a href="#">徐老師</a>和其他 219 人最近都說<a href="#">家政富</a>-->
                    <?php echo $text; ?>
                </div>
                <div class="notice-icon">
                    <!-- <p class="icon-heart page-icons"></p> -->
                    <p class="notice-time"><?php echo $data->createTime; ?></p>
                </div>
            </div>
