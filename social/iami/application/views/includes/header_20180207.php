    ...
    <div class="container-wide">
      ...
      <div class="header-container clearfix"> 
        ...
        <div class="header-left">
          <div class="header-logo"><a href="<?php echo base_url();?>"><img alt="" src="<?php echo base_url();?>assets/img/iami-logo-header.png"></a></div>
          <div class="video-ac-area"><a href="video-show.html"><span class="video-icon"><img src="<?php echo base_url();?>assets/img/5s-video-icon.png"></span><span class="video-txt">我就是我影片專區</span></a></div>
        </div>
        <!--header-middle-->
        ...
        <div class="header-right">
          ...
          <ul class="self-dropdown">
            ...
            <li class="self-dropdown-cnt"><a href="#"><span>周子瑜</span><img src="<?php echo base_url();?>assets/img/self-img-arrow.png"> </a></li>
          </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  <div class="flyout-cnt"> <a href="<?php echo base_url();?>friend">
                    <div class="user-pic-s"><img src="<?php echo base_url();?>assets/img/default.png"></div>
              ...
              <ul>
                ...
                <li>
                  ...
                  <div class="flyout-cnt"><a href="#"  id="addClass">
                    <div class="user-pic-s"><img src="<?php echo base_url();?>assets/img/<?php echo $avatar;?>"></div>
                    <div class="pic-s-info">
