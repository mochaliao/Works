            ...
            <div class="content-area">
                        ...
                        <div class="edit-pic-wrap">
                            <div class="edit-pic-cnt">
                                ...
                                <div class="edit-pic">
                                    <a href="#">
                                        <img alt="" src="<?= $avatar ?>"
                                             onerror="this.src='/assets/img/self-user-pic.jpg'" style="width:100%">
                                    </a>
                                </div>
                ...
                <?php if (!$is_myself && !$isFriend && !$isTrace): ?>
                    <div class="notFd-wrapper">
                        <div class="notFd"><?= $this->lang->line('need_add_friend_1') ?>
                            <br><?= $this->lang->line('need_add_friend_2') ?></div>
                    </div>
                <?php else: ?>
                    <div class="ctn-wrap">
                        <!--cnt-left-->
                                            ...
                                            <div class="post-pic">
                                                <ul>
                                                    <li><span class="delete-btn-up-pic"></span><img
                                                                src="/assets/img/self-user-pic.jpg"></li>
                                                    <li><span class="delete-btn-up-pic"></span><img
                                                                src="/assets/img/self-user-pic.jpg"></li>
                                                    <li><span class="delete-btn-up-pic"></span><img
                                                                src="/assets/img/self-user-pic.jpg"></li>
                                            ...
                                            <ul class="self-infom-inner">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="pos-rel">
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('nickname'))?'':'active';?>"><?= form_error('nickname'); ?></span>

                                                        <div class="form-tooltip-wrap">
                                                            <div class="form-tooltip">
                                                                <a class="tip-mark">
                                                                    <span class="tooltip-p-text"><?php echo $this->lang->line('nickname_tip_mark');?></span>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('email'))?'':'active';?>"><?= form_error('email'); ?></span>
                                                    </div>
                                                    <!--0515info-->
                                                    <!--
                                                    <div>
                                                ...
                                                <li class="self-info">
                                                    ...
                                                    <textarea name="resume"
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('resume'))?'':'active';?>"><?= form_error('resume'); ?></span>
                                                    </div>
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="resume" <?php echo (in_array("resume", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('birth'))?'':'active';?>"><?= form_error('birth'); ?></span>
                                                    </div>
                                                    <!--0515info-->
                                                    <div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('mobile'))?'':'active';?>"><?= form_error('mobile'); ?></span>
                                                    </div>
                                                    <!--0515info-->
                                                    <div>
                                                ...
                                                <?php for ($i = 0; $i < $company_length && $i < 9; $i++): ?>
                                                    <li class="info-company">
                                                        <div class="info-edit-icon"><img
                                                                    src="/assets/img/svg_icon-43.svg"
                                                                    alt="company"></div>
                                                        <div>
                                                            <div>
                                                                <ul class="self-list-two">
                                                                    <li>
                                                                        <input type="text"
                                                                               placeholder="<?php echo $placeholder_company; ?>"
                                                                               class="input-type2" name="company[]"
                                                                               value="<?php echo $member_companys[$i]["company"]; ?>">
                                                                        <input type="text"
                                                                               placeholder="<?php echo $placeholder_position; ?>"
                                                                               class="input-type2" name="position[]"
                                                                               value="<?php echo $member_companys[$i]["position"]; ?>">
                                                        ...
                                                        <div>
                                                            <label class="checkbox-wrap"> <input type="checkbox"
                                                                                                 name="info_show[]"
                                                                                                 value="companies_<?php echo $i; ?>" <?php echo (in_array("companies_" . $i, $info_show)) ? "checked" : ""; ?>>
                                                                <span
                                                                        class="checkbox-txt"></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <li class="info-company">
                                                            ...
                                                            <ul class="self-list-two">
                                                                <li>
                                                                    <input type="text"
                                                                           placeholder="<?php echo $placeholder_company; ?>"
                                                                           class="input-type2" name="company[]"
                                                                           value="<?php echo isset($member_companys[9]) ? $member_companys[9]["company"] : ""; ?>">
                                                                    <input type="text"
                                                                           placeholder="<?php echo $placeholder_position; ?>"
                                                                           class="input-type2" name="position[]"
                                                                           value="<?php echo isset($member_companys[9]) ? $member_companys[9]["position"] : ""; ?>">
                                                    ...
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="companies_last" <?php echo (in_array("companies_last", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <?php for ($i = 0; $i < $school_length && $i < 9; $i++): ?>
                                                    <li class="info-education">
                                                        <div class="info-edit-icon"><img
                                                                    src="/assets/img/svg_icon-46.svg"
                                                                    alt="Education">
                                                        </div>
                                                        <div>
                                                            <div>
                                                                <ul class="self-list-two">
                                                                    <li>
                                                                        <input type="text"
                                                                               placeholder="<?php echo $placeholder_school; ?>"
                                                                               class="input-type2" name="school[]"
                                                                               value="<?php echo $member_schools[$i]["school"]; ?>">
                                                                        <input type="text"
                                                                               placeholder="<?php echo $placeholder_department; ?>"
                                                                               class="input-type2" name="department[]"
                                                                               value="<?php echo $member_schools[$i]["department"]; ?>">
                                                        ...
                                                        <div>
                                                            <label class="checkbox-wrap"> <input type="checkbox"
                                                                                                 name="info_show[]"
                                                                                                 value="schools_<?php echo $i; ?>" <?php echo (in_array("schools_" . $i, $info_show)) ? "checked" : ""; ?>>
                                                                <span
                                                                        class="checkbox-txt"></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <li class="info-education">
                                                            ...
                                                            <ul class="self-list-two">
                                                                <li>
                                                                    <input type="text"
                                                                           placeholder="<?php echo $placeholder_school; ?>"
                                                                           class="input-type2" name="school[]"
                                                                           value="<?php echo isset($member_schools[9]) ? $member_schools[9]["school"] : ""; ?>">
                                                                    <input type="text"
                                                                           placeholder="<?php echo $placeholder_department; ?>"
                                                                           class="input-type2" name="department[]"
                                                                           value="<?php echo isset($member_schools[9]) ? $member_schools[9]["department"] : ""; ?>">
                                                    ...
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="schools_last" <?php echo (in_array("schools_last", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="error-txt <?php echo empty(form_error('city'))?'':'active';?>"><?= form_error('city'); ?></span>
                                                    </div>
                                                    <!--0515info-->
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="city" <?php echo (in_array("city", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="country" <?php echo (in_array("country", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        <label class="checkbox-wrap"> <input type="checkbox"
                                                                                             name="info_show[]"
                                                                                             value="relationship" <?php echo (in_array("relationship", $info_show)) ? "checked" : ""; ?>>
                                                            <span
                                                                    class="checkbox-txt"></span>
                                                        </label>
                                                    </div>
                                            ...
                                            <div class="info-edit-label">
                                                ...
                                                <div class="info-label">
                                                    ...
                                                    <?php foreach ($labels as $label) { ?>
                                                        <?php $lang = $this->lang->line("$label->labelname"); ?>
                                                        <?php if (!empty($lang)) { ?>
                                                            <article
                                                                    id="<?php echo $label->id; ?>"><?php echo $this->lang->line($label->labelname); ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <article
                                                                    id="<?php echo $label->id; ?>"><?php echo $label->labelname; ?>
                                                                <span><img src="/assets/img/svg_icon-38-w.svg"></span>
                                                                <input type="hidden" name="labels[]"
                                                                       value="<?php echo $label->id; ?>"/>
                                                            </article>
                        ...
                        <div class="ctn-right">
                            <div class="cnt-right-cnt">
                                ...
                                <div class="online box-wrap disable ">
                                    <div class="cog-icon-wrap">
                                        <div class="cog-icon"><a><img src="/assets/img/svg_icon-18.svg"></a></div>
                                    </div>
                                    <div>
                                        <article class="cog-title">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".freestyle-label-btn").click(function (event) {
            ...
            // 載入個人化標籤編輯視窗時，同時載入目前的編輯資訊 (直接複製一份 )
            //var labels = $("div.info-edit-label div.info-label article").clone();
            //$("li.up-label-choose div.info-label").html(labels);
        });
        ...
        $("#edit-self-label").on("click", ".up-label-wrap article:not('.self-add') :checkbox", function () {
            ...
            if ($(this).prop("checked")) {
                ...
                $(".info-edit-cnt .info-label").append("<article id=\"" + $(this).val() + "\">" + $(this).closest("label").siblings("h4").html() + "<span><img src=\"/assets/img/svg_icon-38-w.svg\"></span></article>");
                self.removeAttr("disabled");
            } else {
                ajaxPost("/Label/delLabel", {
                    ...
                    if (data.status == "success") {
                        ...
                        $("#selNum").html($("li.up-label-choose div.info-label article").length);
                    }
                })
            }
        })
        ...
        $("#edit-self-label .info-label").on("click", "article span img", function () {
            // 預設標籤
            var article_check = $("#edit-self-label .up-label-wrap article").find(":checkbox[value=" + $(this).closest("article").attr("lid") + "]");
            if (article_check.length > 0) {
                ...
                $("article[id='" + $(this).closest("article").attr("lid") + "']").remove();
            }
            else {
                ...
                ajaxPost("/Label/delLabel", {
                    ...
                    if (data.status == "success") {
                        $("article[id='" + article.attr("lid") + "']").remove();
                        $("article[lid='" + article.attr("lid") + "']").remove();
                        // article.remove();
                        $("#selNum").html($("li.up-label-choose div.info-label article").length);
                    }
                });
        ...
        $(".info-edit-label .info-label").on("click", "article span img", function () {
            var article_check = $("#edit-self-label .up-label-wrap article").find(":checkbox[value=" + $(this).closest("article").attr("id") + "]");
            if (article_check.length > 0) {
                $("#edit-self-label .up-label-wrap article").find(":checkbox[value=" + $(this).closest("article").attr("id") + "]").get(0).click();
                ...
                ajaxPost("/Label/delLabel", {
                    ...
                    if (data.status == "success") {
                        $("article[id='" + article.attr("id") + "']").remove();
                        $("article[lid='" + article.attr("id") + "']").remove();
                        // article.remove();
                        $("#selNum").html($("li.up-label-choose div.info-label article").length);
                    }
                });
        ...
        $(".self-add-btn").click(function () {
            ...
            if (input == "") {
                ...
                return false;
            } else if (input.Blength() > 12) {
                $(".up-label-input").focus();
                $("<div class=\"errortip\" style=\"text-align:center;color:red\"><?=$this->lang->line('over-the-length');?>!</div>").insertBefore($(".btn-area .pop-btn"));
                return false;
            }
            ...
            ajaxPost("/Label/addLabel", {
                ...
                if (data.status == "success") {
                    ...
                    $("<article  id=\"" + data.data.id + "\">" + input + "<span><img src=\"/assets/img/svg_icon-38-w.svg\"></span></article>").insertAfter($(".info-edit-label #add-label-listen"));
