...
$lang['form_validation_required'] = '{field} 欄位必須要填寫';
$lang['form_validation_isset'] = '{field} 欄位必須要有值';
...
$lang['form_validation_alpha_dash'] = '{field} 欄位取值只允許為字母、數字、底線(_)和破折號(-)';
$lang['form_validation_numeric'] = '{field} 欄位值只允許為數字';
...
$lang['form_validation_is_unique'] = '此{field}已經存在，請輸入別的帳號';
...
$lang['form_validation_gb_max_length'] = '{field} 欄位超長';
$lang['form_validation_sensitive'] = '{field} 包含敏感詞語';
$lang['form_validation_ban_modify_nickname'] = '{field}在{param}后才能再次變更';
