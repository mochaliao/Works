...
include APPPATH . 'third_party/qiniu/auth_digest.php';
include APPPATH . 'third_party/qiniu/conf.php';
...
class Qiniu_MacHttpClient
{
	...
	public function RoundTrip($req) // => ($resp, $error)
	{
		...
		//$req->Header["Content-type"] = "multipart/form-data; boundary=--------------------------469709771130053025184533";
		//$req->Header["Host"] = "up.qbox.me";
        //$req->Header["Connection"] = "keep-alive";
        // $req->Header['Content-Length'] = "123";
		return Qiniu_Client_do($req);
	}
}
