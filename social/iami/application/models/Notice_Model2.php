...
/*getNoticePost*/
        ...
        {       
                ...
                $this->db->join('members', 'members.id=share.member_id','left');
        ...
        {
                $this->db->join('members', 'members.member_id=collection.member_id','left');
        ...
        {
                $this->db->join('member', 'member.member_id=collection.member_id','left');
