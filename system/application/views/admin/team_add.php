    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="admin/team/team_add"><?=$this->lang->line('team_add')?></a>
                </li>
                <li class="nav-item">
        ...
        <div class="card-body">
            ...
            <?=form_open('admin/team/team_add')?>
                
                <div class="form-row">
                
                    <div class="form-group col-md-6">
                        <label for="leader_name"><?=$this->lang->line('team_leader')?></label>
                        <input type="text" class="form-control" id="leader_name" name="leader_name" placeholder="<?=$this->lang->line('team_leader_plz')?>" value="<?=set_value('leader_name')?>" readonly="readonly" data-toggle="modal" data-target="#js-member-modal" required />
                        <input type="hidden" class="form-control" id="leader_id" name="leader_id" value="<?=set_value('leader_id')?>" readonly="readonly" required />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="team_pname"><?=$this->lang->line('team_pname')?></label>
                        <input type="text" class="form-control" id="team_pname" name="team_pname" placeholder="<?=$this->lang->line('team_pid_plz')?>" value="<?=set_value('team_pname')?>" readonly="readonly" data-toggle="modal" data-target="#js-team-modal" />
                        <input type="hidden" class="form-control" id="team_pid" name="team_pid" value="<?=set_value('team_pid', 0)?>" readonly="readonly" />
                    </div>
                    
                    <div class="form-group col-md-6">
                        <label for="name"><?=$this->lang->line('team_name')?></label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="<?=$this->lang->line('team_name')?>" value="<?=set_value('name')?>" required minlength="2" maxlength="80" />
                    </div>
                    <div class="form-group col-md-6">
...
$(document).ready(function(){
    ...
    // 上層團隊選擇器套用
    comm.show_team($('#js-team-modal'), 0, $('input[name=team_pid]'), $('input[name=team_pname]'), 0);
