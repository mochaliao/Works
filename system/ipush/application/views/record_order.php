...
<div class="inner-page-wrap">
	...
	<div class="record-nav">
		<ul>
			...
			<li><a href="<?=current_url()?>" class="active"><?=$this->lang->line('trans_pay')?></a></li>
	...
	<div class="inner-page-l">
		<ul class="table-type table-flex">
			<li class="table-head">
				...
				<div><?=$this->lang->line('trans_product_name')?></div>
...
$(document).ready(function(){
    ...
    $('#js-pager').jqPaginator({
        ...
        onPageChange: function (num, type) {
            if(num != <?=$page?>) document.location.href = 'order/record_order/' + num;
        }
    });
    <?}?>
});
